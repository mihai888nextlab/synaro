...
/** Create / list / revoke account API keys — used on the Security settings page. */
    ...
    <div id="api-keys" className="scroll-mt-6">
      {createdKey ? (
        <div className="rounded-xl border border-amber-500/40 bg-amber-500/10 p-4">
          ...
          <p className="mt-1 text-sm text-muted-foreground">{t("apiKeys.copyNewKeyBody")}</p>
      ...
      <form
        ...
        className={createdKey ? "mt-6 flex flex-wrap items-end gap-3" : "flex flex-wrap items-end gap-3"}
      >
