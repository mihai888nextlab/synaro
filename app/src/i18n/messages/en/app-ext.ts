  ...
  widgets: {
    ...
    types: {
      ...
      agent_last_run_generated: {
        title: "Last run — generated",
        subtitle: "Charts & KPIs from the agent",
        description:
          "Renders structured artifacts the agent designs for each run (charts, rankings, timelines, funnels, tables, and more) — pick the visual story that fits.",
        openAgent: "Open agent",
        noAgentSelected: "Select an agent when adding this widget.",
        agentNotFound: "This agent is no longer available.",
        noRunsYet: "No runs yet for this agent.",
