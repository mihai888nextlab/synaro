...
const enBase: Messages = {
  ...
  dashboard: {
    ...
    addLayoutTemplate: "Agent + metrics layout",
    resizeHint: "Drag corners to resize, or use size chips on each widget.",
    done: "Done",
    reset: "Reset",
    ...
    noLogsBody: "No activity yet. Start or stop a project container, or run an agent, to see events here.",
    mobileMonitorHint: "A compact monitor for your workspace. Customize the full dashboard on a larger screen.",
    mobileOverview: "Overview",
    mobileLastRuns: "Latest runs",
    mobileNoAgents: "No agents yet. Create an agent on desktop to see latest runs here.",
  },
  auth: {
    signIn: "Sign in",
    signUp: "Sign up",
