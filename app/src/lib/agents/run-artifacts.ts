 ...
 * Keep in sync with services/agent-runner/src/lib/run-artifacts.ts
...
/** Preview fixtures for the dashboard widget picker — story-shaped, not a fixed template. */
export const PREVIEW_RUN_ARTIFACTS: RunArtifact[] = [
  {
    id: "hero-readiness",
    type: "kpi_row",
    emphasis: "hero",
    items: [{ label: "Exam readiness", value: "68%", hint: "10 days left", trend: "up" }],
  },
  {
    id: "study-plan",
    type: "timeline",
    ...
    emphasis: "supporting",
    items: [
      { t: "Today", title: "React hooks deep dive", status: "current", description: "3 hours" },
      { t: "Tomorrow", title: "SQL joins + indexes", status: "upcoming", description: "2 hours" },
      { t: "Day 3", title: "System design warm-up", status: "upcoming", description: "2 hours" },
    ],
  },
  {
    id: "focus-rank",
    ...
    items: [
      { rank: 1, label: "System design", value: "High priority", hint: "practice first" },
      { rank: 2, label: "SQL indexing", value: "Medium" },
      { rank: 3, label: "React suspense", value: "Low" },
    ],
  },
];
