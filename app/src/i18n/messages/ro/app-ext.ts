...
export const roAppExt: Messages = {
  ...
  agents: {
    ...
    scheduleAtMinutes: "La minutele din oră",
    scheduleAddTime: "Adaugă altă oră",
    scheduleAddMinute: "Adaugă alt minut",
    scheduleRemoveTime: "Elimină ora",
    scheduleRemoveMinute: "Elimină minutul",
    scheduleGeneratedCron: "Cron:",
    scheduleCustomCron: "Editează ca expresie cron",
    scheduleSummaryHourly: "În fiecare oră la {minutes}",
    ...
    scheduleMinuteRequired: "Adaugă cel puțin un minut din oră.",
  ...
  agentShare: {
    ...
    openAgent: "Deschide agentul",
    createAccount: "Creează cont",
    addToMyAgents: "Adaugă în agenții mei",
    signInToAdd: "Autentifică-te pentru a adăuga",
    addingToAgents: "Se adaugă agentul în contul tău…",
    redirectingToSignIn: "Redirecționare către autentificare…",
    importFailed: "Nu s-a putut adăuga agentul. Încearcă din nou.",
    share: "Partajează",
    ...
    shareHint: "Oricine are acest link poate adăuga o copie a agentului în contul său.",
  },
  contact: {
    hero: {
      badge: "Contact",
